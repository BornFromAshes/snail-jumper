...
if __name__ == '__main__':
    ...
    n = nn.NeuralNetwork([2, 2])
    player = Player("Neuroevolution")
    player2 = Player("Neuroevolution")
    e = Evolution()
    v = e.vectorized(player)
    print(v)
    v = e.vectorized(player2)
    print(v)
    player1, player2 = e.crossover(player, player2)
    print(e.vectorized(player))
    print(e.vectorized(player2))
